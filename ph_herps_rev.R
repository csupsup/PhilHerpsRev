...
p.pie <- ggplot(d.pie[1:5, ], aes("", Percentage, fill = Types)) +
    ...
    theme(axis.line = element_blank(),
          ...
          plot.title = element_text(hjust = 0.5, color = "#666666"), legend.position = c(0.0,0.97), ,text = element_text(size=20)) 
...
grid.arrange(p.for.loc, p.m.f, ncol=2)
dev.off()
```
